...
#define DARDRIVE_M_DDAT_SIZE 0xB
...
#define DARDRIVE_M_CONFIG_ADDRESS       0x9
#define DARDRIVE_M_STATUS_ADDRESS       0xA

#define DARDRIVE_M_INITIATE_NEW      0
#define DARDRIVE_M_INITIATE_EXISTING 1
#define DARDRIVE_M_INITIATE_REMOVE   2

#define DARDRIVE_M_CONFIG_INT_EN_MASK      0b00000001
#define DARDRIVE_M_STATUS_IN_PROGRESS_MASK 0b00000001
#define DARDRIVE_M_STATUS_FAILED_MASK      0b00000010
...
#define DARDRIVE_D_DDAT_SIZE 0xE
...
#define DARDRIVE_D_CONFIG_ADDRESS         0xC
#define DARDRIVE_D_STATUS_ADDRESS         0xD

#define DARDRIVE_D_INITIATE_READ  0
#define DARDRIVE_D_INITIATE_WRITE 1

#define DARDRIVE_D_CONFIG_INT_EN_MASK      0b00000001
#define DARDRIVE_D_STATUS_IN_PROGRESS_MASK 0b00000001
#define DARDRIVE_D_STATUS_FAILED_MASK      0b00000010
